...
'<ul class="ht-us-menu d-flex my-2">
    <li class=""><a href="#">
        <img src="../view/layout/assets/images/'.$img.'" alt="" class="avatar-user">
    </a>
...
<head>
    ...
    <link rel="shortcut icon" href="../assets/images/logolazyfeel.png" type="image/x-icon">
    <link rel="icon" href="../view/layout/assets/images/logolazyfeel.png" type="image/x-icon">
                    ...
                    <div class="container">
                        <div class="row align-items-center h-90">
                            ...
                            <div class="col-lg-3 col-md-3 col-6 order-lg-1 order-md-1 order-1">
                                ...
                                <a href="index.php"><img src="../view/layout/assets/images/logolazyfeel.png" width="160px" height="160px"
                                            alt="logo TG shop"></a>
                                </div>
                            </div>
                            <!--Logo end-->
