...
?>
<div class="my-account-section section pt-20 pt-lg-20 pt-md-70 pt-sm-60 pt-xs-50  pb-100 pb-lg-80 pb-md-70 pb-sm-60 pb-xs-50">
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12 mb-4">
                        <div class="myaccount-tab-menu nav" role="tablist">
                            ...
                            <a href="../Admin/?mod=statistic&act=listdash" data-toggle="tab"><i class="fa fa-cart-arrow-down"></i> ADMIN</a>
                            <?php endif; ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="tf-element-carousel section" data-slick-options='{
                ...
                <div class="brand col"><a href="#"><img src="assets/images/product/thành lukaku.webp" alt=""></a>
                </div>
