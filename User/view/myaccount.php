...
<div class="my-account-section section pt-lg-20 pt-md-70 pt-sm-60   pb-100 pb-lg-80 pb-md-70 pb-sm-60 pb-xs-50">
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12 mb-4">
                        <div class="myaccount-tab-menu nav" role="tablist">
                            ...
                            <a href="" data-toggle="tab"><i class="fa fa-cart-arrow-down"></i> Blog của tôi</a>
                            <?php if (isset($_SESSION['user']) && isset($_SESSION['user']['role']) && $_SESSION['user']['role'] == 1) : ?>
                                <a href="../../Admin/?mod=statistic&act=listdash" data-toggle=""><i class="fa fa-cart-arrow-down"></i> ADMIN</a>
                            <?php endif; ?>
